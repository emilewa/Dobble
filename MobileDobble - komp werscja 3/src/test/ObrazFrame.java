...
public static int idkliknietegoprzycisku; //numer kliknietego przycisku
public JPanel obrazPanel; //Panel z obrazkiem karty
JButton b1,b2,b3,b4,b5,b6,b7,b8; //Przyciski
public static boolean czyodgadniety; //czy karta jest odgadnieta
public static int zmiennapomocnicza; //zmienna pomocnicza
public static  Dane danepomocnicze ; //zmienna pomocnicza
public static int ktorapartia; //ktora partia rozgrywki 
public static int ile; //ile kart w rozgrywce       
public static long starttime; //czas poczatkowy rozgrywki 
public static JFrame i; //okno rozgrywki 
